...
from oml.interfaces.models import IFreezable
from models.model import IMultiQueryModel
from oml.lightning.modules.ddp import ModuleDDP
from oml.miners.pairs import PairsMiner


class MultiQueryModule(pl.LightningModule):
    def __init__(
        self,
        multi_query_model: IMultiQueryModel,
        n_queries: int,
        miner: PairsMiner,
        criterion: nn.Module,
        optimizer: Optimizer,
        ...
        Args:
            multi_query_model: Multi Query model to train
...
class MultiQueryModuleDDP(MultiQueryModule, ModuleDDP):
    def __init__(
        self,
        ...
        **kwargs: Any,
        ...
        MultiQueryModule.__init__(self, *args, **kwargs)


__all__ = ["MultiQueryModule", "MultiQueryModuleDDP"]
